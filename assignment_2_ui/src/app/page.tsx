...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#ffd6e8]/30 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white shadow-2xl dark:bg-black sm:items-start">
        <SummaryCard 
